...
export async function listPublicArticlesService(filters: {
  ...
  return listArticles({ ...filters, publicOnly: true });
}
...
export async function getPublicArticleBySlugService(slug: string): Promise<ArticleRow> {
...
export async function getAdminArticleService(id: string): Promise<ArticleRow> {
